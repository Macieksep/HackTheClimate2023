...
public class AppWindows {
    ...
    public JPanel treeSimulationPanel(CardLayout cardLayout, JPanel cardPanel){
        ...
        JLabel cityTreeInfoLabel = new JLabel("Trees in the city absorbs yeraly:");
        ...
        JLabel outputLabel1 = new JLabel();
            ...
            outputLabel1.setText("CO2 annual absorbtion of this tree:");
        ...
        JLabel outputLabelPlanes = new JLabel("Plane (km)       = 0");
        ...
        heightSlider.addChangeListener(e -> {
            ...
            outputLabelPlanes.setText(      "Plane (km)       = " + porownanie(emission)[1]);
        ...
        diameterSlider.addChangeListener(e -> {
            ...
            outputLabelCO2.setText(emission + " kg CO2");
            outputLabelCigarettes.setText(  "Cigarettes        = " + porownanie(emission)[0]);
            outputLabelPlanes.setText(      "Planes (km)     = " + porownanie(emission)[1]);
            outputLabelCarsPetrol.setText(  "Petrol car (km) = " + porownanie(emission)[2]);
            outputLabelCarsDiesel.setText(  "Diesel car (km) = " + porownanie(emission)[3]);
            outputLabelBreath.setText(      "Breaths            = " + porownanie(emission)[4]);
    ...
    static double algorithm(double diameter, double height){
        ...
        double foot = (5*0.475*3.67*density*diameter*height)/1600;  //do sekcji z wyjsciem bo to ile pochlania rocznie
    ...
    static long footprintmiasto(){
        ...
        return Math.round((volume*density/2)*0.475*3.67/(avgHigh*1.7)); //polowa masy drzewa to sucha masa, 47,5% to węgiel
    ...
    public static int[] porownanie(double emission){
        int[] arr = new int[5];
        arr[0] = (int) Math.round(emission/0.2);  //papieros
        arr[1] = (int) Math.round(emission/0.25); //samolot
        arr[2] = (int) Math.round(emission/2.3);  //benzin
        arr[3] = (int) Math.round(emission/2.7);  //dizelek
